...
(
    ...
    # NOTE: Added `--host=x86_64-unknown-linux-gnu` otherwise compilation failed on my mac
    ...
    # Move artifacts
    # mv rnnoise.wasm ../src/generated/
    # mv $ENTRY_POINT ../src/generated/
    mv $ENTRY_POINT_SYNC ../src/generated/
