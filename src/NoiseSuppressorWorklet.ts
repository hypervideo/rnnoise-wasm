...
import RnnoiseProcessor, { type IRnnoiseModule } from "./RnnoiseProcessor"
...
class NoiseSuppressorWorklet extends AudioWorkletProcessor {
    ...
    constructor() {
         ...
         */
        this._denoiseProcessor = new RnnoiseProcessor(createRNNWasmModuleSync() as IRnnoiseModule)
